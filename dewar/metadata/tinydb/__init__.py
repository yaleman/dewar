""" tinydb implementation of the MetadataStore - likely TERRIBLE in production """
...
class MetadataStore(BaseMetadataStore):
    ...
    def put_hash(self, filehash: str, **kwargs):
        """ base implementation """
        # TODO: dewar.metadata.put_hash: test to see if the hash already exists...
        # TODO: and either update or warn if putting the same thing again
